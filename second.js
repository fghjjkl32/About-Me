...
const bigImage = document.querySelector(".big-box-image"),
    introduceMent = document.querySelector(".introduce_ment"),
    contentArr = ["image/프로필1.jpeg", "image/MBTI.jpeg", "image/전역.jpeg", "image/vehicle.jpeg", "image/ppt.png", "image/wecode.jpeg"],
    introduceMentsArr = [`안녕하세요😆 프론트엔드 개발자가 되고싶은 98년생 전건우입니다 저의 대해 잠깐 소개 해드리겠습니다!`,
        "MBTI는 10번 하면 9번 정도 ISFP나오는 진성 ISFP입니다. 낯을 많이 가리지만 먼저 말을 걸어주시면 감사하겠습니다 (´._.`) <br> 현재를 즐기고 남에 대한 마음을 나누는것을 좋아합니다!",
        "20년 12월 16일 공군 797기 만기전역하여 전역한지 4개월 됐고 공부하기 위해서 1월부터 서울로 올라와서 서울에서 생활한지 3개월 됐습니다 <br> 혹시 괜찮은 서울 맛집 알려주시면 감사하겠습니다🙏",
...
function addImage(num) {
    ...
    introduceMent.innerHTML = `${introduceMentsArr[num]}`;
}